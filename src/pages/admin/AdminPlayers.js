...
const PlayerModal = ({ player, teams, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-start overflow-y-auto py-8">
      <div className="bg-white p-8 rounded-lg max-w-md w-full mx-4 my-auto">
